...
var ya = (t, e, i) => e in t ? Aa(t, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : t[e] = i;
var G = (t, e, i) => ya(t, typeof e != "symbol" ? e + "" : e, i), Ss = (t, e, i) => e.has(t) || vr("Cannot " + i);
...
var Hr = Array.isArray, Ia = Array.prototype.indexOf, hs = Array.from, rs = Object.keys, ns = Object.defineProperty, St = Object.getOwnPropertyDescriptor, Gr = Object.getOwnPropertyDescriptors, Ea = Object.prototype, Ca = Array.prototype, Vs = Object.getPrototypeOf, mr = Object.isExtensible;
function xa(t) {
...
const Z = 2, Zs = 4, ps = 8, Sa = 1 << 24, qe = 16, it = 32, ft = 64, vs = 128, Be = 512, ie = 1024, me = 2048, Fe = 4096, ve = 8192, $e = 16384, Fi = 32768, Bt = 65536, wr = 1 << 17, jr = 1 << 18, zt = 1 << 19, Fr = 1 << 20, ot = 1 << 25, Qt = 32768, Rs = 1 << 21, _s = 1 << 22, lt = 1 << 23, Mt = Symbol("$state"), Wr = Symbol("legacy props"), Ma = Symbol(""), jt = new class extends Error {
  constructor() {
    super(...arguments);
...
const Ha = 1, Ga = 2, Ya = 16, ja = 1, Fa = 2, Wa = 4, qa = 8, Ka = 16, Ja = 4, Xa = 1, Va = 2, Kr = "[", ms = "[!", er = "]", mi = {}, $ = Symbol(), Za = "http://www.w3.org/1999/xhtml";
function ws(t) {
...
let x = null, $i = null, j = null, Ce = [], As = null, Bs = !1, Ri = !1;
var Kt, Jt, yt, It, Hi, Xt, Vt, V, Qs, Mi, Ls, en, tn;
const us = class us {
  constructor() {
    I(this, V);
    G(this, "committed", !1);
  ...
  process(e) {
    ...
    this.is_fork || z(this, V, en).call(this), this.is_deferred() ? (z(this, V, Mi).call(this, i.effects), z(this, V, Mi).call(this, i.render_effects)) : ($i = this, x = null, br(i.render_effects), br(i.effects), $i = null, (s = c(this, Hi)) == null || s.resolve()), j = null;
  }
  /**
...
Ls = function(e) {
  ...
  c(this, yt) === 0 && z(this, V, tn).call(this);
}, tn = function() {
  var n;
  if (Vi.size > 1) {
    this.previous.clear();
...
function je(t) {
  ...
  try {
    for (var i; ; ) {
      if (to(), Ce.length === 0 && (x == null || x.flush(), Ce.length === 0))
...
function br(t) {
  ...
  if (e !== 0) {
    for (var i = 0; i < e; ) {
      var s = t[i++];
      if (!(s.f & ($e | ve)) && Ki(s) && (Te = /* @__PURE__ */ new Set(), Ni(s), s.deps === null && s.first === null && s.nodes === null && (s.teardown === null && s.ac === null ? In(s) : s.fn = null), (Te == null ? void 0 : Te.size) > 0)) {
        dt.clear();
        for (const r of Te) {
  ...
  if (!i.has(t) && (i.add(t), t.reactions !== null))
    for (const r of t.reactions) {
      ...
      n & Z ? rn(
        ...
        i,
        s
      ) : n & (_s | qe) && !(n & me) && nn(r, e, s) && (se(r, me), Lt(
        /** @type {Effect} */
        r
      ));
    }
...
var ye, he, Gi, Pe, Et, ze, Ie, ce, Ne, Xe, rt, Ct, nt, xt, at, gs, F, an, on, Ps, es, ts, zs;
class ao {
  /**
  ...
  constructor(e, i, s) {
     ...
     */
    I(this, at, null);
    I(this, gs, so(() => (y(this, at, Pt(c(this, Ct))), () => {
      y(this, at, null);
    })));
    ...
    R.b, y(this, ye, !!c(this, Pe).pending), y(this, ze, nr(() => {
      if (R.b = this, D) {
        ...
        n.data === ms ? z(this, F, on).call(this) : z(this, F, an).call(this);
      } else {
  ...
  error(e) {
    ...
    const a = () => {
      ...
      r = !0, n && Ua(), He.ensure(), y(this, Ct, 0), c(this, Ne) !== null && Ot(c(this, Ne), () => {
        y(this, Ne, null);
...
ye = new WeakMap(), he = new WeakMap(), Gi = new WeakMap(), Pe = new WeakMap(), Et = new WeakMap(), ze = new WeakMap(), Ie = new WeakMap(), ce = new WeakMap(), Ne = new WeakMap(), Xe = new WeakMap(), rt = new WeakMap(), Ct = new WeakMap(), nt = new WeakMap(), xt = new WeakMap(), at = new WeakMap(), gs = new WeakMap(), F = new WeakSet(), an = function() {
  try {
...
es = function(e) {
  ...
  c(this, Ie) !== null && (y(this, Xe, document.createDocumentFragment()), c(this, Xe).append(
    /** @type {TemplateNode} */
    c(this, rt)
  ), xn(c(this, Ie), c(this, Xe))), c(this, ce) === null && y(this, ce, xe(() => e(c(this, he))));
}, /**
...
function oo(t, e, i, s) {
  ...
  function l() {
    Promise.all(i.map((d) => /* @__PURE__ */ co(d))).then((d) => {
      o();
      try {
        s([...e.map(r), ...d]);
      } catch (u) {
...
function co(t, e) {
  ...
  return Ao(() => {
    ...
    if (a) {
      var u = !s.is_pending();
      s.update_pending_count(1), d.increment(u), (f = o.get(d)) == null || f.reject(jt), o.delete(d), o.set(d, l);
    }
    const h = (p, g = void 0) => {
      if (d.activate(), g)
        g !== jt && (n.f |= lt, Ai(n, g));
...
function dn(t) {
  var e = ir(t);
  if (t.equals(e) || (x != null && x.is_fork || (t.v = e), t.wv = Mn()), !Nt)
    if (j !== null)
      (Pi() || x != null && x.is_fork) && j.set(t, e);
    else {
      var i = t.f & Be ? ie : Fe;
      se(t, i);
    }
...
function un(t, e = !1, i = !0) {
  var r;
  const s = Pt(t);
  return e || (s.equals = Zr), Ei && i && U !== null && U.l !== null && ((r = U.l).s ?? (r.s = [])).push(s), s;
}
function C(t, e, i = !1) {
  M !== null && // since we are untracking the function inside `$inspect.with` we need to add this check
  // to ensure we error if state is set inside an inspect effect
  (!Ge || M.f & wr) && Wi() && M.f & (Z | qe | _s | wr) && !(le != null && le.includes(t)) && Na();
  let s = i ? te(e) : e;
  return Ai(t, s);
}
function Ai(t, e) {
  if (!t.equals(e)) {
    ...
    s.capture(t, i), t.f & Z && (t.f & me && ir(
      /** @type {Derived} */
      t
    ), se(t, t.f & Be ? ie : Fe)), t.wv = Mn(), gn(t, me), Wi() && R !== null && R.f & ie && !(R.f & (it | ft)) && (Ae === null ? Eo([t]) : Ae.push(t)), !s.is_fork && Ns.size > 0 && !cn && go();
  }
  return e;
}
function go() {
    ...
    for (var s = Wi(), r = i.length, n = 0; n < r; n++) {
      ...
      if (!(!s && a === R)) {
        ...
        if (l && se(a, e), o & Z) {
          ...
          j == null || j.delete(d), o & Qt || (o & Be && (a.f |= Qt), gn(d, Fe));
...
function te(t) {
  ...
  if (e !== Ea && e !== Ca)
    return t;
  var i = /* @__PURE__ */ new Map(), s = Hr(t), r = /* @__PURE__ */ T(0), n = Rt, a = (o) => {
    if (Rt === n)
      return o();
    var l = M, d = Rt;
    ue(null), Er(n);
...
function Us() {
  if (Ar === void 0) {
    Ar = window, fn = /Firefox/.test(navigator.userAgent);
    var t = Element.prototype, e = Node.prototype, i = Text.prototype;
    hn = St(e, "firstChild").get, pn = St(e, "nextSibling").get, mr(t) && (t.__click = void 0, t.__className = void 0, t.__attributes = null, t.__style = void 0, t.__e = void 0), mr(i) && (i.__t = void 0);
  }
}
function Qe(t = "") {
...
function Le(t, e, i) {
  ...
  !(n.f & zt) && (n = n.first, t & qe && t & Bt && n !== null && (n.f |= Bt)), n !== null && (n.parent = s, s !== null && vo(n, s), M !== null && M.f & Z && !(t & ft))) {
    var a = (
      /** @type {Derived} */
      M
    );
...
function oe(t, e = !0) {
  var i = !1;
  (e || t.f & jr) && t.nodes !== null && t.nodes.end !== null && (Io(
    t.nodes.start,
    /** @type {TemplateNode} */
    t.nodes.end
  ), i = !0), yn(t, e && !i), ds(t, 0), se(t, $e);
  ...
  An(t);
  var r = t.parent;
  r !== null && r.first !== null && In(t), t.next = t.prev = t.teardown = t.ctx = t.deps = t.fn = t.nodes = t.ac = null;
}
function Io(t, e) {
  for (; t !== null; ) {
...
function Co(t, e) {
  ...
  (ne === null || !ne.includes(e)) && (se(e, Fe), e.f & Be && (e.f ^= Be, e.f &= ~Qt), ln(
    /** @type {Derived} **/
    e
  ), ds(
    /** @type {Derived} **/
...
function m(t) {
  ...
  if (Nt) {
    ...
    if (i) {
      ...
      return (!(a.f & ie) && a.reactions !== null || Bn(a)) && (o = ir(a)), dt.set(a, o), o;
    }
  } else i && (!(j != null && j.has(t)) || x != null && x.is_fork && !Pi()) && (a = /** @type {Derived} */
  t, Ki(a) && dn(a), Dt && Pi() && !(a.f & Be) && Rn(a));
  if (j != null && j.has(t))
    return j.get(t);
  if (t.f & lt)
    throw t.v;
...
function Rn(t) {
  if (t.deps !== null) {
    ...
    for (const e of t.deps)
      (e.reactions ?? (e.reactions = [])).push(t), e.f & Z && !(e.f & Be) && Rn(
        /** @type {Derived} */
        e
      );
  }
...
const Qn = /* @__PURE__ */ new Set(), Gs = /* @__PURE__ */ new Set();
function To(t, e, i, s = {}) {
  function r(n) {
...
function Oo(t, e, i, s, r) {
  var n = { capture: s, passive: r }, a = To(t, e, i, n);
...
// @__NO_SIDE_EFFECTS__
function K(t, e) {
  var i = (e & Xa) !== 0, s = (e & Va) !== 0, r, n = !t.startsWith("<!>");
  return () => {
    if (D)
      return ct(k, null), k;
    r === void 0 && (r = Ln(n ? t : "<!>" + t), i || (r = /** @type {TemplateNode} */
    /* @__PURE__ */ et(r)));
    var a = (
      /** @type {TemplateNode} */
      s || fn ? document.importNode(r, !0) : r.cloneNode(!0)
    );
    if (i) {
      var o = (
        /** @type {TemplateNode} */
...
`).some((o) => o.startsWith("https://svelte.dev/e/")))
      throw a;
    return a !== mi && console.warn("Failed to hydrate: ", a), e.recover === !1 && Qa(), Us(), sr(i), _e(!1), or(t, e);
  } finally {
    _e(s), we(r);
  }
}
const Yt = /* @__PURE__ */ new Map();
function Pn(t, { target: e, anchor: i, props: s = {}, events: r, context: n, intro: a = !0 }) {
  Us();
  var o = /* @__PURE__ */ new Set(), l = (h) => {
    for (var f = 0; f < h.length; f++) {
      ...
      if (!o.has(p)) {
        ...
        var w = Yt.get(p);
        w === void 0 ? (document.addEventListener(p, Ti, { passive: g }), Yt.set(p, 1)) : Yt.set(p, w + 1);
      }
    }
  };
  l(hs(Qn)), Gs.add(l);
    ...
    return no(
      ...
      (f) => {
        ...
        if (r && (s.$$events = r), D && ct(
          ...
          f,
          null
        ), Ys = a, d = t(f, s) || {}, Ys = !0, D && (R.nodes.end = k, k === null || k.nodeType !== Ii || /** @type {Comment} */
        k.data !== er))
          throw ws(), mi;
        n && pt();
      }
      ...
      for (var f of o) {
        ...
        --p === 0 ? (document.removeEventListener(f, Ti), Yt.delete(f)) : Yt.set(f, p);
      }
...
function Fs(t, e) {
  const i = js.get(t);
  return i ? (js.delete(t), i(e)) : Promise.resolve();
}
var De, Ue, pe, kt, Yi, ji, fs;
class Lo {
  /**
        ...
        for (const [n, a] of c(this, Ue)) {
          ...
          const o = () => {
            if (Array.from(c(this, De).values()).includes(n)) {
              ...
              xn(a, d), d.append(Qe()), c(this, pe).set(n, { effect: a, fragment: d });
            } else
              oe(a);
            c(this, kt).delete(n), c(this, Ue).delete(n);
          };
          c(this, Yi) || !s ? (c(this, kt).add(n), Ot(a, o, !1)) : o();
        }
      }
    });
    /**
   ...
   */
    ...
    if (c(this, De).set(s, e), r) {
      ...
      s.oncommit(c(this, ji)), s.ondiscard(c(this, fs));
    } else
      D && (this.anchor = k), c(this, ji).call(this);
  }
}
De = new WeakMap(), Ue = new WeakMap(), pe = new WeakMap(), kt = new WeakMap(), Yi = new WeakMap(), ji = new WeakMap(), fs = new WeakMap();
function ke(t, e, i = !1) {
  D && bs();
  var s = new Lo(t), r = i ? Bt : 0;
  function n(a, o) {
    if (D) {
      const d = Xr(t) === ms;
      if (a === d) {
...
var xr;
function zo(t, e, i, s, r, n = null) {
  var a = t, o = /* @__PURE__ */ new Map();
  D && bs();
  var l = null, d = /* @__PURE__ */ tr(() => {
    var w = i();
    return Hr(w) ? w : w == null ? [] : hs(w);
  }), u, h = !0;
  function f() {
    g.fallback = l, No(g, u, a, e, s), l !== null && (u.length === 0 ? l.f & ot ? (l.f ^= ot, Oi(l, null, a)) : ar(l) : Ot(l, () => {
      l = null;
    }));
  }
  var p = nr(() => {
    ...
    for (var O = /* @__PURE__ */ new Set(), H = (
      ...
      J ? (J.v && Ai(J.v, de), J.i && Ai(J.i, Q), B && H.skipped_effects.delete(J.e)) : (J = Uo(
        o,
        h ? a : xr ?? (xr = Qe()),
        de,
        ge,
...
function Uo(t, e, i, s, r, n, a, o) {
  var l = a & Ha ? a & Ya ? Pt(i) : /* @__PURE__ */ un(i, !1, !1) : null, d = a & Ga ? Pt(r) : null;
  return {
    v: l,
    i: d,
    e: xe(() => (n(e, l ?? i, d ?? r, o), () => {
...
function zn() {
  ...
  }), Ze.tasks.size !== 0 && Ze.tick(zn);
}
function Go(t) {
  let e;
  return Ze.tasks.size === 0 && Ze.tick(zn), {
...
function Sr(t, e, i, s) {
  var v;
  var r = (t & Ja) !== 0, n = "both", a, o = e.inert, l = e.style.overflow, d, u;
  function h() {
...
function qs(t, e, i, s, r) {
  ...
  const { delay: l = 0, css: d, tick: u, easing: h = jo } = e;
  var f = [];
...
const Ko = Symbol("is custom element"), Jo = Symbol("is html");
function tt(t, e, i, s) {
  var r = Xo(t);
  D && (r[e] = t.getAttribute(e), e === "src" || e === "srcset" || e === "href" && t.nodeName === "LINK") || r[e] !== (r[e] = i) && (e === "loading" && (t[Ma] = i), i == null ? t.removeAttribute(e) : typeof i != "string" && Vo(t).includes(e) ? t[e] = i : t.setAttribute(e, i));
}
function Xo(t) {
  return (
    ...
    t.__attributes ?? (t.__attributes = {
      [Ko]: t.nodeName.includes("-"),
      [Jo]: t.namespaceURI === Za
    })
  );
}
...
function Zo(t, e, i = e) {
  ...
  po(t, "input", async (r) => {
    ...
    if (n = Ms(t) ? Ts(n) : n, i(n), x !== null && s.add(x), await Dn(), n !== (n = e())) {
...
function ut(t, e, i, s) {
  var H;
  var r = !Ei || (i & Fa) !== 0, n = (i & qa) !== 0, a = (i & Ka) !== 0, o = (
    /** @type {V} */
    s
  ), l = !0, d = () => (l && (l = !1, o = a ? vt(
    /** @type {() => V} */
  ...
  t[e], f === void 0 && s !== void 0 && (f = d(), u && (r && La(), u(f)));
  var g;
  if (r ? g = () => {
    var B = (
      /** @type {V} */
  ...
  constructor(e) {
    ...
    const r = new Proxy(
      { ...e.props || {}, $$events: {} },
      {
        ...
        has(a, o) {
          return o === Wr ? !0 : (m(i.get(o) ?? s(o, Reflect.get(a, o))), Reflect.has(a, o));
        },
        set(a, o, l) {
    ...
    y(this, Ee, (e.hydrate ? Qo : or)(e.component, {
      target: e.target,
      anchor: e.anchor,
      props: r,
      context: e.context,
      intro: e.intro ?? !1,
      recover: e.recover
    })), (!((n = e == null ? void 0 : e.props) != null && n.$$host) || e.sync === !1) && je(), y(this, Ve, r.$$events);
...
function cr(t) {
  U === null && qr(), Ei && U.l !== null ? rl(U).m.push(t) : Tt(() => {
    const e = vt(t);
...
const nl = "5";
var Ur;
typeof window < "u" && ((Ur = window.__svelte ?? (window.__svelte = {})).v ?? (Ur.v = /* @__PURE__ */ new Set())).add(nl);
const al = (t) => t;
function ol(t) {
  const e = t - 1;
  return e * e * e + 1;
...
function ll(t, { delay: e = 0, duration: i = 400, easing: s = al } = {}) {
...
function dl(t, { delay: e = 0, duration: i = 400, easing: s = ol, x: r = 0, y: n = 0, opacity: a = 0 } = {}) {
...
function Yn(t) {
  const e = Gn(t), i = parseInt(e.slice(1, 3), 16) / 255, s = parseInt(e.slice(3, 5), 16) / 255, r = parseInt(e.slice(5, 7), 16) / 255, n = Math.max(i, s, r), a = Math.min(i, s, r);
  let o = 0, l = 0;
  const d = (n + a) / 2;
  if (n !== a) {
    const u = n - a;
...
class hl {
  ...
  parseElementAttributes(e) {
    ...
    for (const r of s) {
      const n = Un.attributeToProperty(r);
      if (!n) continue;
...
function Fn(t, e) {
  ...
  const s = /* @__PURE__ */ Se(() => Y.isOpen), r = /* @__PURE__ */ Se(() => Y.hasUnreadMessages);
...
class Li {
  ...
  static handle(e, i) {
    const s = Sl(e);
    let r;
    return e instanceof Wt ? r = "NETWORK_ERROR" : e instanceof qn ? r = "WEBSOCKET_ERROR" : e instanceof Qi ? r = "VALIDATION_ERROR" : e instanceof Kn ? r = "CONFIGURATION_ERROR" : e instanceof Jn ? r = "AUTHENTICATION_ERROR" : e instanceof qt ? r = "RATE_LIMIT_ERROR" : e instanceof Xn ? r = "STORAGE_ERROR" : e instanceof Vn ? r = "TIMEOUT_ERROR" : e instanceof be ? r = "WIDGET_ERROR" : r = "UNKNOWN_ERROR", {
      message: Ml(e),
      code: r,
      isUserFacing: !0,
      shouldRetry: Lr(e),
...
const Tl = "https://ai-gateway-service-staging-639717727892.us-east4.run.app";
class Ks {
  ...
  static resolveProductionUrls(e) {
    const i = Tl, s = this.isLocalhostUrl(i) ? i : this.ensureHttps(i);
    return {
...
For production: npm run build (uses default staging gateway)`
      ...
      const a = Wn.validate(n.clientId);
      if (!a.isValid)
...
const Oe = class Oe {
  ...
  setItem(e, i) {
    this.storageAdapter ? this.storageAdapter.setItem(e, i) : Bl(e, i);
  }
  removeItem(e) {
    this.storageAdapter ? this.storageAdapter.removeItem(e) : Ql(e);
  }
  /**
...
Ht($n, {}, [], [], !0);
var Fl = /* @__PURE__ */ K('<div class="empty-state svelte-qha2j" role="status" aria-label="BotBrewers assistant ready"><div class="empty-icon svelte-qha2j" aria-hidden="true"><img alt="" class="brand-logo svelte-qha2j" width="68" height="68"/></div> <span class="brand-name svelte-qha2j">BotBrewers</span></div>'), Wl = /* @__PURE__ */ K('<div class="messages-container svelte-qha2j" role="list" aria-label="Messages"><!> <!></div>'), ql = /* @__PURE__ */ K('<div class="error-message svelte-qha2j"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-qha2j"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20Z" fill="#ef4444"></path><path d="M11 7H13V13H11V7ZM11 15H13V17H11V15Z" fill="#ef4444"></path></svg> <p class="svelte-qha2j"> </p></div>'), Kl = /* @__PURE__ */ K('<div class="message-list svelte-qha2j" role="log" aria-live="polite" aria-label="Chat conversation"><!> <!></div>');
const Jl = {
  hash: "svelte-qha2j",
...
function ea(t, e) {
  ...
  async function r() {
    await Dn(), i && (i.scrollTop = i.scrollHeight);
  }
  function n() {
    if (i) {
  ...
  {
    var l = (f) => {
      var p = Fl(), g = q(p), w = q(g);
      W(g), Jr(2), W(p), gt(() => tt(w, "src", bl)), N(f, p);
    }, d = (f) => {
      var p = Wl(), g = q(p);
      zo(g, 17, () => S.messages, (v) => v.id, (v, A) => {
        _n(v, {
          get message() {
            return m(A);
          }
...
function ta(t, e) {
  ...
  fo(g), g.__keydown = o, g.__input = l, dr(g, (v) => n = v, () => n);
  var w = X(g, 2);
  return w.__click = a, W(p), W(f), gt(
    ...
    [() => m(d) || !m(r).trim()]
  ), Zo(g, () => m(r), (v) => C(r, v)), N(t, f), pt(h);
}
Is(["keydown", "input", "click"]);
Ht(ta, { onsend: {}, disabled: {} }, [], [], !0);
class Zl {
  constructor(e, i) {
...
var $l = /* @__PURE__ */ K('<span class="error-message svelte-zsv8oa" id="error-message">Connection lost. Unable to reconnect.</span> <button class="restart-button svelte-zsv8oa" aria-describedby="error-message">Retry Connection</button>', 1), ed = /* @__PURE__ */ K('<span class="error-message svelte-zsv8oa" id="error-message">Something went wrong. Please try again.</span> <button class="restart-button svelte-zsv8oa" aria-describedby="error-message">Retry Connection</button>', 1), td = /* @__PURE__ */ K('<div class="error-banner svelte-zsv8oa" role="alert" aria-live="polite"><!></div>'), id = /* @__PURE__ */ K('<button class="backdrop svelte-zsv8oa" aria-label="Close chat overlay" tabindex="-1"></button>'), sd = /* @__PURE__ */ K('<div class="chat-container svelte-zsv8oa" role="dialog" aria-label="Chat assistant" aria-modal="true" tabindex="-1"><!> <!> <!> <!></div> <!>', 1), rd = /* @__PURE__ */ K('<div class="widget-container svelte-zsv8oa"><!> <!></div>');
const nd = {
  hash: "svelte-zsv8oa",
...
function ia(t, e) {
  ...
  function H(b) {
    if (b.key === "Escape" && Y.isOpen) {
      b.preventDefault(), Y.close(), Q();
      return;
    }
    if (b.key === "Tab" && m(w)) {
      const L = [
  ...
  cr(async () => {
    try {
      if (s = new Ol(i()), l = gr(s.getAll()), r = new Js(), n = new Zl(s, r), a = new Ll(s, r), o = new _l(S, Y, l), i()) {
        const { configStore: b } = await Promise.resolve().then(() => pl);
      ...
      }), l.log("ChatWidget", "WebSocket listeners attached successfully"), Y.isOpen && await ge(), l.log("ChatWidget", "Services initialized successfully");
    } catch (b) {
  ...
  async function ge() {
    ...
    if (!(u || h)) {
      h = !0;
      try {
        if (Y.setLoading(!0), await n.resumeSession()) {
  ...
  async function sa(b) {
    ...
    if (o.resetForNewMessage(), l.log("ChatWidget", "Message added to store", {
      ...
      try {
        ...
        }), S.addMessage(_.response, "assistant"), S.setTyping(!1), Y.isOpen || Y.markUnread();
      } catch (_) {
  ...
  async function ra() {
    l.log("ChatWidget", "Toggle clicked, current state", m(Ji)), Y.isOpen || B(), Y.toggle(), await new Promise((b) => setTimeout(b, 0)), l.log("ChatWidget", "New state", Y.isOpen), Y.isOpen && !u && s && await ge(), Y.isOpen ? requestAnimationFrame(() => de()) : Q();
  }
  function na() {
  ...
  const Ji = /* @__PURE__ */ Se(() => Y.isOpen), oa = /* @__PURE__ */ Se(() => Y.isLoading), la = /* @__PURE__ */ Se(() => (s == null ? void 0 : s.position) || "bottom-right");
  var da = {
    get hostElement() {
      return i();
    },
  ...
  var ua = X(hr, 2);
  {
    var ga = (b) => {
      ...
      var pr = X(mt, 2);
      {
        let Me = /* @__PURE__ */ Se(() => S.error !== null || m(oa));
        ta(pr, {
          onsend: sa,
          get disabled() {
            return m(Me);
      ...
      var fa = X(pr, 2);
      {
        var ha = (Me) => {
          ...
          {
            var wa = (Gt) => {
              var ki = $l(), ks = X(is(ki), 2);
              ks.__click = aa, N(Gt, ki);
            }, ba = (Gt) => {
              var ki = ed(), ks = X(is(ki), 2);
              ks.__click = na, N(Gt, ki);
            };
            ke(ma, (Gt) => {
              m(g) ? Gt(wa) : Gt(ba, !1);
            });
      ...
      var pa = X(E, 2);
      {
        var va = (Me) => {
          var wt = id();
          wt.__click = () => Y.close(), Sr(3, wt, () => ll, () => ({ duration: 200 })), N(Me, wt);
        };
        ke(pa, (Me) => {
          m(Ji) && Me(va);
        });
      }
      Sr(3, E, () => dl, () => ({ y: 20, duration: 300 })), N(b, L);
    };
    ke(ua, (b) => {
      m(Ji) && b(ga);
    });
  }
  return W(Xi), gt(() => tt(Xi, "data-position", m(la))), N(t, Xi), pt(da);
}
Is(["keydown", "click"]);
Ht(ia, { hostElement: {} }, [], [], !0);
const fr = {
...
class zr extends HTMLElement {
  ...
  mountApp() {
    ...
    s.textContent = this.getStyles(), this._shadowRoot.innerHTML = "", this._shadowRoot.appendChild(s), this._shadowRoot.appendChild(i), this._app = or(ia, {
      target: i,
      props: {
        hostElement: this
      }
  ...
  updateAccentColor(e) {
    ...
    i && Promise.resolve().then(() => fl).then(({ adjustColor: s }) => {
...
customElements.get("assistant-widget") ? customElements.get("chat-widget") || customElements.define("chat-widget", zr) : customElements.define("assistant-widget", zr);
