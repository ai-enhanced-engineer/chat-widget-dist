...
var Ea = (t, e, i) => e in t ? Ia(t, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : t[e] = i;
var G = (t, e, i) => Ea(t, typeof e != "symbol" ? e + "" : e, i), Ss = (t, e, i) => e.has(t) || vr("Cannot " + i);
var c = (t, e, i) => (Ss(t, e, "read from private field"), i ? i.call(t) : e.get(t)), I = (t, e, i) => e.has(t) ? vr("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), y = (t, e, i, s) => (Ss(t, e, "write to private field"), s ? s.call(t, i) : e.set(t, i), i), z = (t, e, i) => (Ss(t, e, "access private method"), i);
var Gr = Array.isArray, Ca = Array.prototype.indexOf, hs = Array.from, rs = Object.keys, ns = Object.defineProperty, St = Object.getOwnPropertyDescriptor, jr = Object.getOwnPropertyDescriptors, xa = Object.prototype, ka = Array.prototype, Vs = Object.getPrototypeOf, mr = Object.isExtensible;
function Sa(t) {
...
const Z = 2, Zs = 4, ps = 8, Ta = 1 << 24, qe = 16, it = 32, ft = 64, vs = 128, Be = 512, ie = 1024, me = 2048, Fe = 4096, ve = 8192, $e = 16384, Fi = 32768, Bt = 65536, wr = 1 << 17, Fr = 1 << 18, zt = 1 << 19, Wr = 1 << 20, ot = 1 << 25, Qt = 32768, Rs = 1 << 21, _s = 1 << 22, lt = 1 << 23, Mt = Symbol("$state"), qr = Symbol("legacy props"), Oa = Symbol(""), Yt = new class extends Error {
  constructor() {
    super(...arguments);
...
const ja = 1, Ya = 2, Fa = 16, Wa = 1, qa = 2, Ka = 4, Ja = 8, Xa = 16, Va = 4, Za = 1, _a = 2, Jr = "[", ms = "[!", er = "]", mi = {}, $ = Symbol(), $a = "http://www.w3.org/1999/xhtml";
function ws(t) {
...
let x = null, $i = null, Y = null, Ce = [], As = null, Bs = !1, Ri = !1;
var Kt, Jt, yt, It, Hi, Xt, Vt, V, Qs, Mi, Ls, tn, sn;
const us = class us {
  constructor() {
    I(this, V);
    G(this, "committed", !1);
  ...
  is_deferred() {
    return this.is_fork || c(this, It) > 0;
  }
  /**
   *
  ...
  process(e) {
    ...
    for (const r of e)
      z(this, V, Qs).call(this, r, i);
    this.is_fork || z(this, V, tn).call(this), this.is_deferred() ? (z(this, V, Mi).call(this, i.effects), z(this, V, Mi).call(this, i.render_effects)) : ($i = this, x = null, br(i.render_effects), br(i.effects), $i = null, (s = c(this, Hi)) == null || s.resolve()), Y = null;
  }
  /**
  ...
  flush() {
    if (this.activate(), Ce.length > 0) {
      if (rn(), x !== null && x !== this)
        return;
    } else c(this, yt) === 0 && this.process([]);
    this.deactivate();
  }
  discard() {
    for (const e of c(this, Jt)) e(this);
    c(this, Jt).clear();
  }
  /**
   *
   ...
   */
  increment(e) {
    y(this, yt, c(this, yt) + 1), e && y(this, It, c(this, It) + 1);
  }
  /**
   *
   * @param {boolean} blocking
   */
  decrement(e) {
    y(this, yt, c(this, yt) - 1), e && y(this, It, c(this, It) - 1), this.revive();
  }
  revive() {
    for (const e of c(this, Xt))
      c(this, Vt).delete(e), se(e, me), Lt(e);
  ...
  settled() {
    return (c(this, Hi) ?? y(this, Hi, Yr())).promise;
  }
  static ensure() {
    if (x === null) {
      const e = x = new us();
      Vi.add(x), Ri || us.enqueue(() => {
        x === e && e.flush();
      });
    }
    return x;
...
Kt = new WeakMap(), Jt = new WeakMap(), yt = new WeakMap(), It = new WeakMap(), Hi = new WeakMap(), Xt = new WeakMap(), Vt = new WeakMap(), V = new WeakSet(), /**
...
Qs = function(e, i) {
  ...
  for (var s = e.first; s !== null; ) {
    var r = s.f, n = (r & (it | ft)) !== 0, a = n && (r & ie) !== 0, o = a || (r & ve) !== 0 || this.skipped_effects.has(s);
    if (s.f & vs && ((u = s.b) != null && u.is_pending()) && (i = {
      ...
      n ? s.f ^= ie : r & Zs ? i.effects.push(s) : Ki(s) && (s.f & qe && c(this, Xt).add(s), Ni(s));
      var l = s.first;
      if (l !== null) {
        s = l;
        continue;
    ...
    for (s = s.next; s === null && d !== null; )
      d === i.effect && (z(this, V, Mi).call(this, i.effects), z(this, V, Mi).call(this, i.render_effects), i = /** @type {EffectTarget} */
...
Mi = function(e) {
  for (const i of e)
    i.f & me ? c(this, Xt).add(i) : i.f & Fe && c(this, Vt).add(i), z(this, V, Ls).call(this, i.deps), se(i, ie);
}, /**
...
Ls = function(e) {
  if (e !== null)
    for (const i of e)
      !(i.f & Z) || !(i.f & Qt) || (i.f ^= Qt, z(this, V, Ls).call(
        this,
        /** @type {Derived} */
        i.deps
      ));
  ...
  if (c(this, It) === 0) {
    for (const e of c(this, Kt)) e();
    c(this, Kt).clear();
  }
  c(this, yt) === 0 && z(this, V, sn).call(this);
}, sn = function() {
  var n;
  if (Vi.size > 1) {
    this.previous.clear();
...
function Ye(t) {
  ...
  try {
    for (var i; ; ) {
      if (so(), Ce.length === 0 && (x == null || x.flush(), Ce.length === 0))
...
function br(t) {
  ...
  if (e !== 0) {
    for (var i = 0; i < e; ) {
      var s = t[i++];
      if (!(s.f & ($e | ve)) && Ki(s) && (Te = /* @__PURE__ */ new Set(), Ni(s), s.deps === null && s.first === null && s.nodes === null && (s.teardown === null && s.ac === null ? En(s) : s.fn = null), (Te == null ? void 0 : Te.size) > 0)) {
        dt.clear();
        for (const r of Te) {
          if (r.f & ($e | ve)) continue;
          const n = [r];
          let a = r.parent;
          for (; a !== null; )
  ...
  if (!i.has(t) && (i.add(t), t.reactions !== null))
    for (const r of t.reactions) {
      ...
      n & Z ? nn(
        ...
        i,
        s
      ) : n & (_s | qe) && !(n & me) && an(r, e, s) && (se(r, me), Lt(
        /** @type {Effect} */
        r
      ));
    }
...
function no(t) {
  let e = 0, i = Pt(0), s;
  return () => {
    Pi() && (m(i), ys(() => (e === 0 && (s = vt(() => t(() => Bi(i)))), e += 1, () => {
      Ci(() => {
        e -= 1, e === 0 && (s == null || s(), s = void 0, Bi(i));
      });
    })));
  };
}
...
var ye, he, Gi, Pe, Et, ze, Ie, ce, Ne, Xe, rt, Ct, nt, xt, at, gs, F, on, ln, Ps, es, ts, zs;
class lo {
  /**
  ...
  constructor(e, i, s) {
     ...
     */
    I(this, at, null);
    I(this, gs, no(() => (y(this, at, Pt(c(this, Ct))), () => {
      y(this, at, null);
    })));
    y(this, he, e), y(this, Pe, i), y(this, Et, s), this.parent = /** @type {Effect} */
    R.b, y(this, ye, !!c(this, Pe).pending), y(this, ze, nr(() => {
      if (R.b = this, D) {
        const n = c(this, Gi);
        bs(), /** @type {Comment} */
        n.nodeType === Ii && /** @type {Comment} */
        n.data === ms ? z(this, F, ln).call(this) : z(this, F, on).call(this);
      } else {
        var r = z(this, F, Ps).call(this);
        try {
          y(this, Ie, xe(() => s(r)));
        } catch (n) {
          this.error(n);
        }
        c(this, nt) > 0 ? z(this, F, ts).call(this) : y(this, ye, !1);
      }
      return () => {
        var n;
  ...
  update_pending_count(e) {
    z(this, F, zs).call(this, e), y(this, Ct, c(this, Ct) + e), c(this, at) && Ai(c(this, at), c(this, Ct));
  }
  get_effect_pending() {
    return c(this, gs).call(this), m(
      /** @type {Source<number>} */
      c(this, at)
    );
  }
  /** @param {unknown} error */
  error(e) {
    var i = c(this, Pe).onerror;
    let s = c(this, Pe).failed;
    if (c(this, xt) || !i && !s)
      throw e;
    c(this, Ie) && (oe(c(this, Ie)), y(this, Ie, null)), c(this, ce) && (oe(c(this, ce)), y(this, ce, null)), c(this, Ne) && (oe(c(this, Ne)), y(this, Ne, null)), D && (we(
      /** @type {TemplateNode} */
      c(this, Gi)
    ), Xr(), we(as()));
    var r = !1, n = !1;
    const a = () => {
      ...
      r = !0, n && Ga(), He.ensure(), y(this, Ct, 0), c(this, Ne) !== null && Ot(c(this, Ne), () => {
        y(this, Ne, null);
      }), y(this, ye, this.has_pending_snippet()), y(this, Ie, z(this, F, es).call(this, () => (y(this, xt, !1), xe(() => c(this, Et).call(this, c(this, he)))))), c(this, nt) > 0 ? z(this, F, ts).call(this) : y(this, ye, !1);
    };
    var o = M;
    try {
      ue(null), n = !0, i == null || i(e, a), n = !1;
    } catch (l) {
      bi(l, c(this, ze) && c(this, ze).parent);
    } finally {
      ue(o);
    }
    s && Ci(() => {
      y(this, Ne, z(this, F, es).call(this, () => {
        He.ensure(), y(this, xt, !0);
        try {
          return xe(() => {
            s(
              c(this, he),
...
ye = new WeakMap(), he = new WeakMap(), Gi = new WeakMap(), Pe = new WeakMap(), Et = new WeakMap(), ze = new WeakMap(), Ie = new WeakMap(), ce = new WeakMap(), Ne = new WeakMap(), Xe = new WeakMap(), rt = new WeakMap(), Ct = new WeakMap(), nt = new WeakMap(), xt = new WeakMap(), at = new WeakMap(), gs = new WeakMap(), F = new WeakSet(), on = function() {
  try {
    y(this, Ie, xe(() => c(this, Et).call(this, c(this, he))));
  } catch (e) {
    this.error(e);
  }
  y(this, ye, !1);
  ...
  e && (y(this, ce, xe(() => e(c(this, he)))), He.enqueue(() => {
    var i = z(this, F, Ps).call(this);
    y(this, Ie, z(this, F, es).call(this, () => (He.ensure(), xe(() => c(this, Et).call(this, i))))), c(this, nt) > 0 ? z(this, F, ts).call(this) : (Ot(
      /** @type {Effect} */
      c(this, ce),
      () => {
        y(this, ce, null);
...
es = function(e) {
  var i = R, s = M, r = U;
  We(c(this, ze)), ue(c(this, ze)), wi(c(this, ze).ctx);
  try {
    return e();
  } catch (n) {
    return en(n), null;
  ...
  c(this, Ie) !== null && (y(this, Xe, document.createDocumentFragment()), c(this, Xe).append(
    /** @type {TemplateNode} */
    c(this, rt)
  ), kn(c(this, Ie), c(this, Xe))), c(this, ce) === null && y(this, ce, xe(() => e(c(this, he))));
}, /**
...
zs = function(e) {
  ...
  if (!this.has_pending_snippet()) {
    this.parent && z(i = this.parent, F, zs).call(i, e);
    return;
  }
  y(this, nt, c(this, nt) + e), c(this, nt) === 0 && (y(this, ye, !1), c(this, ce) && Ot(c(this, ce), () => {
    y(this, ce, null);
  }), c(this, Xe) && (c(this, he).before(c(this, Xe)), y(this, Xe, null)));
};
function co(t, e, i, s) {
  const r = Wi() ? qi : tr;
  ...
  function l() {
    Promise.all(i.map((d) => /* @__PURE__ */ go(d))).then((d) => {
      o();
      try {
        s([...e.map(r), ...d]);
      } catch (u) {
...
function uo() {
  var t = R, e = M, i = U, s = x;
  return function(n = !0) {
    We(t), ue(e), wi(i), n && (s == null || s.activate());
  };
}
function os() {
  We(null), ue(null), wi(null);
}
// @__NO_SIDE_EFFECTS__
function qi(t) {
  var e = Z | me, i = M !== null && M.f & Z ? (
    /** @type {Derived} */
    M
  ) : null;
  return R !== null && (R.f |= zt), {
    ctx: U,
    deps: null,
    effects: null,
    equals: Zr,
  ...
  return Io(() => {
    ...
    try {
      Promise.resolve(t()).then(l.resolve, l.reject).then(() => {
        d === x && d.committed && d.deactivate(), os();
      });
    } catch (p) {
      l.reject(p), os();
    }
    ...
    if (a) {
      var u = !s.is_pending();
      s.update_pending_count(1), d.increment(u), (f = o.get(d)) == null || f.reject(Yt), o.delete(d), o.set(d, l);
    }
    const h = (p, g = void 0) => {
      if (d.activate(), g)
        g !== Yt && (n.f |= lt, Ai(n, g));
      else {
        n.f & lt && (n.f ^= lt), Ai(n, p);
        for (const [w, v] of o) {
...
function cn(t) {
  var e = ir(t);
  if (t.equals(e) || (x != null && x.is_fork || (t.v = e), t.wv = Tn()), !Nt)
    if (Y !== null)
      (Pi() || x != null && x.is_fork) && Y.set(t, e);
    else {
      var i = t.f & Be ? ie : Fe;
      se(t, i);
    }
...
// @__NO_SIDE_EFFECTS__
function gn(t, e = !1, i = !0) {
  var r;
  const s = Pt(t);
  return e || (s.equals = _r), Ei && i && U !== null && U.l !== null && ((r = U.l).s ?? (r.s = [])).push(s), s;
}
function C(t, e, i = !1) {
  M !== null && // since we are untracking the function inside `$inspect.with` we need to add this check
  // to ensure we error if state is set inside an inspect effect
  (!Ge || M.f & wr) && Wi() && M.f & (Z | qe | _s | wr) && !(le != null && le.includes(t)) && Ha();
  let s = i ? te(e) : e;
  return Ai(t, s);
}
function Ai(t, e) {
  if (!t.equals(e)) {
    var i = t.v;
    Nt ? dt.set(t, e) : dt.set(t, i), t.v = e;
    var s = He.ensure();
    s.capture(t, i), t.f & Z && (t.f & me && ir(
      /** @type {Derived} */
      t
    ), se(t, t.f & Be ? ie : Fe)), t.wv = Tn(), fn(t, me), Wi() && R !== null && R.f & ie && !(R.f & (it | ft)) && (Ae === null ? xo([t]) : Ae.push(t)), !s.is_fork && Ns.size > 0 && !un && ho();
  }
  return e;
}
function ho() {
...
function fn(t, e) {
  var i = t.reactions;
  if (i !== null)
    for (var s = Wi(), r = i.length, n = 0; n < r; n++) {
      var a = i[n], o = a.f;
      if (!(!s && a === R)) {
        var l = (o & me) === 0;
        if (l && se(a, e), o & Z) {
          ...
          Y == null || Y.delete(d), o & Qt || (o & Be && (a.f |= Qt), fn(d, Fe));
        } else l && (o & qe && Te !== null && Te.add(
          /** @type {Effect} */
          a
        ), Lt(
          /** @type {Effect} */
...
function te(t) {
  ...
  if (e !== xa && e !== ka)
    return t;
  var i = /* @__PURE__ */ new Map(), s = Gr(t), r = /* @__PURE__ */ T(0), n = Rt, a = (o) => {
    if (Rt === n)
      return o();
    var l = M, d = Rt;
    ue(null), Er(n);
  ...
  return s && i.set("length", /* @__PURE__ */ T(
    /** @type {any[]} */
    t.length
  )), new Proxy(
    /** @type {any} */
    t,
    {
      ...
      get(o, l, d) {
        ...
        if (u === void 0 && (!h || (p = St(o, l)) != null && p.writable) && (u = a(() => {
          var g = te(h ? o[l] : $), w = /* @__PURE__ */ T(g);
          return w;
        }), i.set(l, u)), u !== void 0) {
          var f = m(u);
          return f === $ ? void 0 : f;
      ...
      has(o, l) {
        ...
        if (l === Mt)
          return !0;
        var d = i.get(l), u = d !== void 0 && d.v !== $ || Reflect.has(o, l);
        if (d !== void 0 || R !== null && (!u || (f = St(o, l)) != null && f.writable)) {
          d === void 0 && (d = a(() => {
            var p = u ? te(o[l]) : $, g = /* @__PURE__ */ T(p);
            return g;
          }), i.set(l, d));
          var h = m(d);
          if (h === $)
      ...
      set(o, l, d, u) {
        ...
        if (s && l === "length")
          ...
          h.v; p += 1) {
            var g = i.get(p + "");
            g !== void 0 ? C(g, $) : p in o && (g = a(() => /* @__PURE__ */ T($)), i.set(p + "", g));
          }
        if (h === void 0)
          (!f || (H = St(o, l)) != null && H.writable) && (h = a(() => /* @__PURE__ */ T(void 0)), C(h, te(d)), i.set(l, h));
        else {
          f = h.v !== $;
          var w = a(() => te(d));
          C(h, w);
        ...
        if (v != null && v.set && v.set.call(u, d), !f) {
...
function Us() {
  if (Ar === void 0) {
    Ar = window, hn = /Firefox/.test(navigator.userAgent);
    var t = Element.prototype, e = Node.prototype, i = Text.prototype;
    pn = St(e, "firstChild").get, vn = St(e, "nextSibling").get, mr(t) && (t.__click = void 0, t.__className = void 0, t.__attributes = null, t.__style = void 0, t.__e = void 0), mr(i) && (i.__t = void 0);
  }
}
function Qe(t = "") {
...
function is(t, e = !1) {
  ...
  if (e && (k == null ? void 0 : k.nodeType) !== $s) {
    var s = Qe();
    return k == null || k.before(s), we(s), s;
  }
  return k;
}
function X(t, e = 1, i = !1) {
  let s = D ? k : t;
  for (var r; e--; )
  ...
  if (!D)
    return s;
  if (i && (s == null ? void 0 : s.nodeType) !== $s) {
    var n = Qe();
...
function mo(t, e, i, s = i) {
  t.addEventListener(e, () => xi(i));
  const r = t.__on_r;
  r ? t.__on_r = () => {
    r(), s(!0);
  } : t.__on_r = () => s(!0), vo();
...
function Le(t, e, i) {
  ...
  !(n.f & zt) && (n = n.first, t & qe && t & Bt && n !== null && (n.f |= Bt)), n !== null && (n.parent = s, s !== null && wo(n, s), M !== null && M.f & Z && !(t & ft))) {
    var a = (
      /** @type {Derived} */
      M
    );
...
function bo(t) {
  return wn(), Le(ps | Wr, t, !0);
}
function Ao(t) {
  He.ensure();
  const e = Le(ft | zt, t, !0);
  return () => {
    oe(e);
  };
}
...
function In(t, e = !1) {
  ...
  for (t.first = t.last = null; i !== null; ) {
    ...
    var s = i.next;
    i.f & ft ? i.parent = null : oe(i, e), i = s;
  }
}
function Eo(t) {
...
function oe(t, e = !0) {
  var i = !1;
  (e || t.f & Fr) && t.nodes !== null && t.nodes.end !== null && (Co(
    t.nodes.start,
    /** @type {TemplateNode} */
    t.nodes.end
  ), i = !0), In(t, e && !i), ds(t, 0), se(t, $e);
...
function Cn(t, e, i) {
  if (!(t.f & ve)) {
    ...
    for (var r = t.first; r !== null; ) {
      var n = r.next, a = (r.f & Bt) !== 0 || // If this is a branch effect without a block effect parent,
...
function xn(t, e) {
  if (t.f & ve) {
    t.f ^= ve, t.f & ie || (se(t, me), Lt(t));
    for (var i = t.first; i !== null; ) {
      var s = i.next, r = (i.f & Bt) !== 0 || (i.f & it) !== 0;
      xn(i, r ? e : !1), i = s;
    }
  ...
  if (s !== null && !(le != null && le.includes(t)))
    for (var r = 0; r < s.length; r++) {
      ...
      n.f & Z ? On(
        ...
        e,
        !1
      ) : e === n && (i ? se(n, me) : n.f & ie && se(n, Fe), Lt(
        /** @type {Effect} */
        n
      ));
    }
...
function Dn(t) {
  var g;
  var e = ne, i = fe, s = Ae, r = M, n = le, a = U, o = Ge, l = Rt, d = t.f;
  ne = /** @type {null | Value[]} */
  null, fe = 0, Ae = null, M = d & (it | ft) ? null : t, le = null, wi(t.ctx), Ge = !1, Rt = ++zi, t.ac !== null && (xi(() => {
    t.ac.abort(Yt);
  }), t.ac = null);
  try {
    t.f |= Rs;
    ...
    if (ne !== null) {
      ...
      if (Pi() && t.f & Be)
        for (p = fe; p < f.length; p++)
          ((g = f[p]).reactions ?? (g.reactions = [])).push(t);
    } else f !== null && fe < f.length && (ds(t, fe), f.length = fe);
    if (Wi() && Ae !== null && !Ge && f !== null && !(t.f & (Z | Fe | me)))
    ...
    return r !== null && r !== t && (zi++, Ae !== null && (s === null ? s = Ae : s.push(.../** @type {Source[]} */
    Ae))), t.f & lt && (t.f ^= lt), h;
  } catch (w) {
    return en(w);
  } finally {
    t.f ^= Rs, ne = e, fe = i, Ae = s, M = r, le = n, wi(a), Ge = o, Rt = l;
  }
}
function ko(t, e) {
  let i = e.reactions;
  ...
  (ne === null || !ne.includes(e)) && (se(e, Fe), e.f & Be && (e.f ^= Be, e.f &= ~Qt), dn(
    /** @type {Derived} **/
    e
  ), ds(
    /** @type {Derived} **/
...
function m(t) {
  var e = t.f, i = (e & Z) !== 0;
  if (M !== null && !Ge) {
    var s = R !== null && (R.f & $e) !== 0;
    if (!s && !(le != null && le.includes(t))) {
      var r = M.deps;
      if (M.f & Rs)
        t.rv < zi && (t.rv = zi, ne === null && r !== null && r[fe] === t ? fe++ : ne === null ? ne = [t] : ne.includes(t) || ne.push(t));
      else {
        (M.deps ?? (M.deps = [])).push(t);
        var n = t.reactions;
        n === null ? t.reactions = [M] : n.includes(M) || n.push(M);
      }
    }
  }
  if (Nt) {
    ...
    if (i) {
      ...
      return (!(a.f & ie) && a.reactions !== null || Qn(a)) && (o = ir(a)), dt.set(a, o), o;
    }
  } else i && (!(Y != null && Y.has(t)) || x != null && x.is_fork && !Pi()) && (a = /** @type {Derived} */
  t, Ki(a) && cn(a), Dt && Pi() && !(a.f & Be) && Bn(a));
  if (Y != null && Y.has(t))
    return Y.get(t);
  if (t.f & lt)
    throw t.v;
...
function Bn(t) {
  if (t.deps !== null) {
    ...
    for (const e of t.deps)
      (e.reactions ?? (e.reactions = [])).push(t), e.f & Z && !(e.f & Be) && Bn(
        /** @type {Derived} */
        e
      );
  }
...
function Mo(t) {
  if (!(typeof t != "object" || !t || t instanceof EventTarget)) {
    if (Mt in t)
      ...
      for (let e in t) {
        const i = t[e];
        typeof i == "object" && i && Mt in i && Hs(i);
      }
  }
}
...
const Ln = /* @__PURE__ */ new Set(), Gs = /* @__PURE__ */ new Set();
function Do(t, e, i, s = {}) {
  function r(n) {
    if (s.capture || Ti.call(e, n), !n.cancelBubble)
      return xi(() => i == null ? void 0 : i.call(this, n));
  }
...
function Ro(t, e, i, s, r) {
  var n = { capture: s, passive: r }, a = Do(t, e, i, n);
...
function Ti(t) {
  ...
  r[a] || t.target, n !== e) {
    ...
    try {
      ...
      t.__root = e, delete t.currentTarget, ue(u), We(h);
    }
  }
}
function Pn(t) {
...
// @__NO_SIDE_EFFECTS__
function K(t, e) {
  var i = (e & Za) !== 0, s = (e & _a) !== 0, r, n = !t.startsWith("<!>");
  return () => {
    if (D)
      return ct(k, null), k;
    r === void 0 && (r = Pn(n ? t : "<!>" + t), i || (r = /** @type {TemplateNode} */
    /* @__PURE__ */ et(r)));
    var a = (
      /** @type {TemplateNode} */
      s || hn ? document.importNode(r, !0) : r.cloneNode(!0)
    );
    if (i) {
      var o = (
        /** @type {TemplateNode} */
...
function N(t, e) {
  if (D) {
    ...
    (!(i.f & Fi) || i.nodes.end === null) && (i.nodes.end = k), bs();
    return;
  }
  t !== null && t.before(
    /** @type {Node} */
...
function Po(t, e) {
  ...
  try {
    for (var n = /* @__PURE__ */ et(i); n && (n.nodeType !== Ii || /** @type {Comment} */
    n.data !== Jr); )
      n = /* @__PURE__ */ Ke(n);
    if (!n)
      throw mi;
...
`).some((o) => o.startsWith("https://svelte.dev/e/")))
      throw a;
    return a !== mi && console.warn("Failed to hydrate: ", a), e.recover === !1 && Pa(), Us(), sr(i), _e(!1), or(t, e);
  } finally {
    _e(s), we(r);
  }
}
const jt = /* @__PURE__ */ new Map();
function zn(t, { target: e, anchor: i, props: s = {}, events: r, context: n, intro: a = !0 }) {
  Us();
  var o = /* @__PURE__ */ new Set(), l = (h) => {
    for (var f = 0; f < h.length; f++) {
      ...
      if (!o.has(p)) {
        o.add(p);
        var g = Oo(p);
        e.addEventListener(p, Ti, { passive: g });
        var w = jt.get(p);
        w === void 0 ? (document.addEventListener(p, Ti, { passive: g }), jt.set(p, 1)) : jt.set(p, w + 1);
      }
    }
  };
  l(hs(Ln)), Gs.add(l);
    ...
    return oo(
      ...
      (f) => {
        ...
        if (r && (s.$$events = r), D && ct(
          ...
          f,
          null
        ), js = a, d = t(f, s) || {}, js = !0, D && (R.nodes.end = k, k === null || k.nodeType !== Ii || /** @type {Comment} */
        k.data !== er))
          throw ws(), mi;
        n && pt();
      }
      ...
      var g;
      for (var f of o) {
        e.removeEventListener(f, Ti);
        var p = (
          /** @type {number} */
          jt.get(f)
        );
        --p === 0 ? (document.removeEventListener(f, Ti), jt.delete(f)) : jt.set(f, p);
      }
      Gs.delete(l), h !== i && ((g = h.parentNode) == null || g.removeChild(h));
    };
  });
  return Ys.set(d, u), d;
}
...
function Fs(t, e) {
  const i = Ys.get(t);
  return i ? (Ys.delete(t), i(e)) : Promise.resolve();
}
var De, Ue, pe, kt, ji, Yi, fs;
class zo {
  /**
  ...
  constructor(e, i = !0) {
    ...
    I(this, Yi, () => {
      ...
      if (c(this, De).has(e)) {
        ...
        if (s)
          ar(s), c(this, kt).delete(i);
        else {
          var r = c(this, pe).get(i);
          r && (c(this, Ue).set(i, r.effect), c(this, pe).delete(i), r.fragment.lastChild.remove(), this.anchor.before(r.fragment), s = r.effect);
        }
        ...
        for (const [n, a] of c(this, Ue)) {
          if (n === i || c(this, kt).has(n)) continue;
          const o = () => {
            if (Array.from(c(this, De).values()).includes(n)) {
              var d = document.createDocumentFragment();
              kn(a, d), d.append(Qe()), c(this, pe).set(n, { effect: a, fragment: d });
            } else
              oe(a);
            c(this, kt).delete(n), c(this, Ue).delete(n);
          };
          c(this, ji) || !s ? (c(this, kt).add(n), Ot(a, o, !1)) : o();
        }
      }
    });
    /**
   ...
   */
    ...
    if (i && !c(this, Ue).has(e) && !c(this, pe).has(e))
      if (r) {
    ...
    if (c(this, De).set(s, e), r) {
      ...
      s.oncommit(c(this, Yi)), s.ondiscard(c(this, fs));
    } else
      D && (this.anchor = k), c(this, Yi).call(this);
  }
}
De = new WeakMap(), Ue = new WeakMap(), pe = new WeakMap(), kt = new WeakMap(), ji = new WeakMap(), Yi = new WeakMap(), fs = new WeakMap();
function ke(t, e, i = !1) {
  D && bs();
  var s = new zo(t), r = i ? Bt : 0;
  function n(a, o) {
    if (D) {
      const d = Vr(t) === ms;
      if (a === d) {
        var l = as();
        we(l), s.anchor = l, _e(!1), s.ensure(a, o), _e(!0);
        return;
      }
    }
    s.ensure(a, o);
      ...
      () => {
        if (n) {
          if (n.pending.delete(h), n.done.add(h), n.pending.size === 0) {
            ...
            Ws(hs(n.done)), f.delete(n), f.size === 0 && (t.outrogroups = null);
          }
        } else
          a -= 1;
      },
...
var xr;
function Uo(t, e, i, s, r, n = null) {
  var a = t, o = /* @__PURE__ */ new Map();
  D && bs();
  var l = null, d = /* @__PURE__ */ tr(() => {
    var w = i();
    return Gr(w) ? w : w == null ? [] : hs(w);
  }), u, h = !0;
  function f() {
    g.fallback = l, Ho(g, u, a, e, s), l !== null && (u.length === 0 ? l.f & ot ? (l.f ^= ot, Oi(l, null, a)) : ar(l) : Ot(l, () => {
      l = null;
    }));
  }
  var p = nr(() => {
    ...
    if (D) {
      var A = Vr(a) === ms;
      A !== (w === 0) && (a = as(), we(a), _e(!1), v = !0);
    }
    for (var O = /* @__PURE__ */ new Set(), H = (
      /** @type {Batch} */
      x
    ), B = mn(), Q = 0; Q < w; Q += 1) {
      D && k.nodeType === Ii && /** @type {Comment} */
      k.data === er && (a = /** @type {Comment} */
      k, v = !0, _e(!1));
      var de = u[Q], ge = s(de, Q), J = h ? null : o.get(ge);
      J ? (J.v && Ai(J.v, de), J.i && Ai(J.i, Q), B && H.skipped_effects.delete(J.e)) : (J = Go(
        o,
        h ? a : xr ?? (xr = Qe()),
        de,
        ge,
        ...
        e,
        i
      ), h || (J.e.f |= ot), o.set(ge, J)), O.add(ge);
    }
    if (w === 0 && n && !l && (h ? l = xe(() => n(a)) : (l = xe(() => n(xr ?? (xr = Qe()))), l.f |= ot)), D && w > 0 && we(as()), !h)
      if (B) {
...
function Ho(t, e, i, s, r) {
  var J;
  var n = e.length, a = t.items, o = t.effect.first, l, d = null, u = [], h = [], f, p, g, w;
  for (w = 0; w < n; w += 1) {
    if (f = e[w], p = r(f, w), g = /** @type {EachItem} */
    ...
    if (g.f & ot)
      if (g.f ^= ot, g === o)
        ...
        var v = d ? d.next : o;
        g === t.effect.last && (t.effect.last = g.prev), g.prev && (g.prev.next = g.next), g.next && (g.next.prev = g.prev), st(t, d, g), st(t, g, v), Oi(g, v, i), d = g, u = [], h = [], o = d.next;
        continue;
      }
    if (g.f & ve && ar(g), g !== o) {
      if (l !== void 0 && l.has(g)) {
        if (u.length < h.length) {
          var A = h[0], O;
          d = A.prev;
          var H = u[0], B = u[u.length - 1];
          for (O = 0; O < u.length; O += 1)
            Oi(u[O], A, i);
          for (O = 0; O < h.length; O += 1)
            l.delete(h[O]);
          st(t, H.prev, B.next), st(t, d, H), st(t, B, A), o = A, d = B, w -= 1, u = [], h = [];
        } else
          l.delete(g), Oi(g, o, i), st(t, g.prev, g.next), st(t, g, d === null ? t.effect.first : d.next), st(t, d, g), d = g;
        continue;
      }
      for (u = [], h = []; o !== null && o !== g; )
    ...
    g.f & ot || u.push(g), d = g, o = g.next;
  }
  if (t.outrogroups !== null) {
    for (const re of t.outrogroups)
      re.pending.size === 0 && (Ws(hs(re.done)), (J = t.outrogroups) == null || J.delete(re));
...
function Go(t, e, i, s, r, n, a, o) {
  var l = a & ja ? a & Fa ? Pt(i) : /* @__PURE__ */ gn(i, !1, !1) : null, d = a & Ya ? Pt(r) : null;
  return {
    v: l,
    i: d,
    e: xe(() => (n(e, l ?? i, d ?? r, o), () => {
...
function Nn() {
  const t = Ze.now();
  Ze.tasks.forEach((e) => {
    e.c(t) || (Ze.tasks.delete(e), e.f());
  }), Ze.tasks.size !== 0 && Ze.tick(Nn);
}
function Yo(t) {
  let e;
  return Ze.tasks.size === 0 && Ze.tick(Nn), {
    promise: new Promise((i) => {
      Ze.tasks.add(e = { c: t, f: i });
    }),
    abort() {
      Ze.tasks.delete(e);
    }
...
function Sr(t, e, i, s) {
  var v;
  var r = (t & Va) !== 0, n = "both", a, o = e.inert, l = e.style.overflow, d, u;
  function h() {
    return xi(() => a ?? (a = i()(e, (s == null ? void 0 : s()) ?? /** @type {P} */
    {}, {
      direction: n
    })));
  }
  var f = {
    is_global: r,
    in() {
      e.inert = o, Zi(e, "introstart"), d = qs(e, h(), u, 1, () => {
        Zi(e, "introend"), d == null || d.abort(), d = a = void 0, e.style.overflow = l;
      });
    },
    out(A) {
      e.inert = !0, Zi(e, "outrostart"), u = qs(e, h(), d, 0, () => {
        Zi(e, "outroend"), A == null || A();
      });
    },
    stop: () => {
...
function qs(t, e, i, s, r) {
  ...
  const { delay: l = 0, css: d, tick: u, easing: h = Wo } = e;
  var f = [];
  if (n && i === void 0 && (u && u(0, 1), d)) {
    var p = kr(d(0, 1));
    f.push(p, p);
  }
  var g = () => 1 - s, w = t.animate(f, { duration: l, fill: "forwards" });
  return w.onfinish = () => {
    w.cancel();
    ...
    if (O > 0) {
      ...
      if (d)
        for (var Q = Math.ceil(O / 16.666666666666668), de = 0; de <= Q; de += 1) {
          var ge = v + A * h(de / Q), J = kr(d(ge, 1 - ge));
          H.push(J), B || (B = J.overflow === "hidden");
        }
      B && (t.style.overflow = "hidden"), g = () => {
        var re = (
          /** @type {number} */
    ...
    w = t.animate(H, { duration: O, fill: "forwards" }), w.onfinish = () => {
      g = () => s, u == null || u(s, 1 - s), r();
    };
  }, {
    abort: () => {
      w && (w.cancel(), w.effect = null, w.onfinish = Si);
    },
    deactivate: () => {
      r = Si;
    },
    ...
    for (var r in i)
      if (i[r])
        ...
        for (var n = r.length, a = 0; (a = s.indexOf(r, a)) >= 0; ) {
          var o = a + n;
          (a === 0 || Mr.includes(s[a - 1])) && (o === s.length || Mr.includes(s[o])) ? s = (a === 0 ? "" : s.substring(0, a)) + s.substring(o + 1) : a = o;
        }
  }
  return s === "" ? null : s;
}
...
const Xo = Symbol("is custom element"), Vo = Symbol("is html");
function tt(t, e, i, s) {
  var r = Zo(t);
  D && (r[e] = t.getAttribute(e), e === "src" || e === "srcset" || e === "href" && t.nodeName === "LINK") || r[e] !== (r[e] = i) && (e === "loading" && (t[Oa] = i), i == null ? t.removeAttribute(e) : typeof i != "string" && _o(t).includes(e) ? t[e] = i : t.setAttribute(e, i));
}
function Zo(t) {
  return (
...
function _o(t) {
  var e = t.getAttribute("is") || t.nodeName, i = Tr.get(e);
  if (i) return i;
  Tr.set(e, i = []);
...
function $o(t, e, i = e) {
  ...
  mo(t, "input", async (r) => {
    ...
    if (n = Ms(t) ? Ts(n) : n, i(n), x !== null && s.add(x), await Rn(), n !== (n = e())) {
  ...
  vt(e) == null && t.value) && (i(Ms(t) ? Ts(t.value) : t.value), x !== null && s.add(x)), ys(() => {
    var r = e();
    ...
    Ms(t) && r === Ts(t.value) || t.type === "date" && !r && !t.value || r !== t.value && (t.value = r ?? "");
  });
}
function Ms(t) {
  var e = t.type;
...
function dr(t = {}, e, i, s) {
  return rr(() => {
    ...
    return ys(() => {
      r = n, n = [], vt(() => {
        t !== i(...n) && (e(t, ...n), r && Or(i(...r), t) && e(null, ...r));
      });
    }), () => {
      Ci(() => {
        n && Or(i(...n), t) && e(null, ...n);
...
function ut(t, e, i, s) {
  var H;
  var r = !Ei || (i & qa) !== 0, n = (i & Ja) !== 0, a = (i & Xa) !== 0, o = (
    /** @type {V} */
    s
  ), l = !0, d = () => (l && (l = !1, o = a ? vt(
    /** @type {() => V} */
  ...
  if (n) {
    var h = Mt in t || qr in t;
    u = ((H = St(t, e)) == null ? void 0 : H.set) ?? (h && e in t ? (B) => t[e] = B : void 0);
  }
  var f, p = !1;
  n ? [f, p] = tl(() => (
    /** @type {V} */
  ...
  t[e], f === void 0 && s !== void 0 && (f = d(), u && (r && za(), u(f)));
  var g;
  if (r ? g = () => {
    var B = (
      /** @type {V} */
  ...
  if (u) {
    ...
    return (
      /** @type {() => V} */
      function(B, Q) {
        return arguments.length > 0 ? ((!r || !Q || w || p) && u(Q ? g() : B), B) : g();
      }
    );
  }
  var v = !1, A = (i & Wa ? qi : tr)(() => (v = !1, g()));
  n && m(A);
  var O = (
    /** @type {Effect} */
    R
  ...
  return (
    ...
    function(B, Q) {
      if (arguments.length > 0) {
        const de = Q ? m(A) : r && n ? te(B) : B;
        return C(A, de), v = !0, o !== void 0 && (o = de), B;
      }
      return Nt && v || O.f & $e ? A.v : m(A);
    }
  );
}
function il(t) {
...
class sl {
  ...
  constructor(e) {
    ...
    const r = new Proxy(
      { ...e.props || {}, $$events: {} },
      {
        ...
        has(a, o) {
          return o === qr ? !0 : (m(i.get(o) ?? s(o, Reflect.get(a, o))), Reflect.has(a, o));
        },
        set(a, o, l) {
    ...
    y(this, Ee, (e.hydrate ? Po : or)(e.component, {
      target: e.target,
      anchor: e.anchor,
      props: r,
      context: e.context,
      intro: e.intro ?? !1,
      recover: e.recover
    })), (!((n = e == null ? void 0 : e.props) != null && n.$$host) || e.sync === !1) && Ye(), y(this, Ve, r.$$events);
    for (const a of Object.keys(c(this, Ee)))
      a === "$set" || a === "$destroy" || a === "$on" || ns(this, a, {
        get() {
          return c(this, Ee)[a];
        },
        /** @param {any} value */
   ...
   */
  $on(e, i) {
    c(this, Ve)[e] = c(this, Ve)[e] || [];
    const s = (...r) => i.call(this, ...r);
    return c(this, Ve)[e].push(s), () => {
      c(this, Ve)[e] = c(this, Ve)[e].filter(
        /** @param {any} fn */
        (r) => r !== s
      );
    };
...
typeof HTMLElement == "function" && (Un = class extends HTMLElement {
  ...
  async connectedCallback() {
    if (this.$$cn = !0, !this.$$c) {
      ...
      for (const r of this.attributes) {
        ...
        n in this.$$d || (this.$$d[n] = ss(n, r.value, this.$$p_d, "toProp"));
      }
  ...
  attributeChangedCallback(e, i, s) {
    var r;
    this.$$r || (e = this.$$g_p(e), this.$$d[e] = ss(e, s, this.$$p_d, "toProp"), (r = this.$$c) == null || r.$set({ [e]: this.$$d[e] }));
  }
...
function Ht(t, e, i, s, r, n) {
  ...
  return rs(e).forEach((o) => {
    ns(a.prototype, o, {
      ...
      set(l) {
        var h;
        l = ss(o, l, e), this.$$d[o] = l;
        var d = this.$$c;
        if (d) {
          var u = (h = St(d, o)) == null ? void 0 : h.get;
          u ? d[o] = l : d.$set({ [o]: l });
        }
      }
    });
...
function cr(t) {
  U === null && Kr(), Ei && U.l !== null ? al(U).m.push(t) : Tt(() => {
    const e = vt(t);
...
const ol = "5";
var Hr;
typeof window < "u" && ((Hr = window.__svelte ?? (window.__svelte = {})).v ?? (Hr.v = /* @__PURE__ */ new Set())).add(ol);
const ll = (t) => t;
function dl(t) {
  const e = t - 1;
  return e * e * e + 1;
...
function cl(t, { delay: e = 0, duration: i = 400, easing: s = ll } = {}) {
...
function ul(t, { delay: e = 0, duration: i = 400, easing: s = dl, x: r = 0, y: n = 0, opacity: a = 0 } = {}) {
  const o = getComputedStyle(t), l = +o.opacity, d = o.transform === "none" ? "" : o.transform, u = l * (1 - a), [h, f] = Rr(r), [p, g] = Rr(n);
  return {
    delay: e,
    duration: i,
    easing: s,
    css: (w, v) => `
			transform: ${d} translate(${(1 - w) * h}${f}, ${(1 - w) * p}${g});
			opacity: ${l - u * v}`
  };
}
var Zt, _t, $t, ei;
class gl {
  constructor() {
    ...
    I(this, $t);
    I(this, ei);
    y(this, Zt, /* @__PURE__ */ T(!1)), y(this, _t, /* @__PURE__ */ T(!1)), y(this, $t, /* @__PURE__ */ T(!1)), y(this, ei, /* @__PURE__ */ T(!1));
  }
  get isOpen() {
    return m(c(this, Zt));
  }
...
Zt = new WeakMap(), _t = new WeakMap(), $t = new WeakMap(), ei = new WeakMap();
const j = new gl(), ae = {
...
class fl {
  constructor() {
    ...
    I(this, ni);
    I(this, ai);
    y(this, ti, /* @__PURE__ */ T(te([]))), y(this, ii, /* @__PURE__ */ T(null)), y(this, si, /* @__PURE__ */ T(!1)), y(this, ri, /* @__PURE__ */ T(null)), y(this, ni, /* @__PURE__ */ T(null)), this.streamingBuffer = "", this.streamingTimeout = null, y(this, ai, /* @__PURE__ */ T(0));
  }
  get messages() {
    return m(c(this, ti));
  }
...
ti = new WeakMap(), ii = new WeakMap(), si = new WeakMap(), ri = new WeakMap(), ni = new WeakMap(), ai = new WeakMap();
const S = new fl(), Qr = {
  "client-id": "clientId",
  theme: "theme",
  position: "position",
  ...
  propertyToAttribute(t) {
    const i = Object.entries(Qr).find(([, s]) => s === t);
    return i ? i[0] : null;
  }
}, hl = [
  "modern",
...
function Yn(t) {
  const e = jn(t), i = parseInt(e.slice(1, 3), 16) / 255, s = parseInt(e.slice(3, 5), 16) / 255, r = parseInt(e.slice(5, 7), 16) / 255, n = Math.max(i, s, r), a = Math.min(i, s, r);
  let o = 0, l = 0;
  const d = (n + a) / 2;
  if (n !== a) {
    const u = n - a;
...
function Re(t, e) {
  if (!Es(t)) return t;
  const i = Yn(t), s = Math.max(0, Math.min(100, i.l + e));
  return Fn(i.h, i.s, s);
}
...
var oi, li, di, ci, ui, gi, fi, hi, pi, vi;
class vl {
  constructor() {
    I(this, oi);
    I(this, li);
    ...
    I(this, pi);
    I(this, vi);
    y(this, oi, /* @__PURE__ */ T("")), y(this, li, /* @__PURE__ */ T(te(Je.theme))), y(this, di, /* @__PURE__ */ T(te(Je.position))), y(this, ci, /* @__PURE__ */ T(te(Je.title))), y(this, ui, /* @__PURE__ */ T(te(Je.logoUrl))), y(this, gi, /* @__PURE__ */ T(te(Je.placeholder))), y(this, fi, /* @__PURE__ */ T(te(Je.accentColor))), y(this, hi, /* @__PURE__ */ T(te(Je.avatarEmoji))), y(this, pi, /* @__PURE__ */ T(te(Je.companyName))), y(this, vi, /* @__PURE__ */ T("default"));
  }
  get clientId() {
    return m(c(this, oi));
  }
...
function Wn(t, e) {
  ...
  let n = /* @__PURE__ */ T(!1), a = /* @__PURE__ */ T("");
  Tt(() => {
    if (m(s) || m(n)) return;
    const v = setTimeout(
      () => {
  ...
  return W(d), gt(() => {
    u = lr(d, 1, `floating-button ${m(a) ?? ""}`, "svelte-bkcus6", u, { open: m(s) }), tt(d, "aria-label", m(s) ? "Close chat" : "Open chat");
  }), N(t, d), pt(l);
}
Is(["click"]);
Ht(Wn, { onclick: {} }, [], [], !0);
...
const P = {
  isDebugEnabled: Os,
  log: (t, e, i) => {
    Os() && (i !== void 0 ? console.log(`[${t}] ${e}:`, i) : console.log(`[${t}] ${e}`));
  },
  warn: (t, e, i) => {
    Os() && (i !== void 0 ? console.warn(`[${t}] ${e}:`, i) : console.warn(`[${t}] ${e}`));
  },
  error: (t, e, i) => {
...
class Ml {
  ...
  static validate(e) {
    ...
    if (s.length > bt.MAX_LENGTH) {
      const a = `Message exceeds maximum length of ${bt.MAX_LENGTH} characters`;
      return P.log("MessageValidator", "Validation failed - too long", {
        correlationId: i,
        trimmedLength: s.length,
        maxLength: bt.MAX_LENGTH,
        error: a
      }), {
        isValid: !1,
        error: a
...
function Ol(t) {
  return t instanceof Wt ? t.statusCode === 404 ? "Service temporarily unavailable. Please try again later." : t.statusCode === 429 || t instanceof qt ? "Too many requests. Please wait a moment and try again." : t.statusCode && t.statusCode >= 500 ? "Server error. Please try again in a few moments." : t.statusCode && (t.statusCode === 400 || t.statusCode === 401 || t.statusCode === 403) ? t.message : "Unable to connect to the server. Please check your internet connection." : t instanceof Kn ? "Connection lost. Attempting to reconnect..." : t instanceof Xn ? "Access denied. Please check your configuration." : t instanceof Qi ? t.message : t instanceof Jn ? "Widget configuration error. Please contact support." : t instanceof Zn ? "Request timed out. Please try again." : t instanceof Vn ? "Unable to save data. Please check your browser settings." : "Something went wrong. Please try again.";
}
class Li {
  /**
  ...
  static handle(e, i) {
    const s = Tl(e);
    let r;
    return e instanceof Wt ? r = "NETWORK_ERROR" : e instanceof Kn ? r = "WEBSOCKET_ERROR" : e instanceof Qi ? r = "VALIDATION_ERROR" : e instanceof Jn ? r = "CONFIGURATION_ERROR" : e instanceof Xn ? r = "AUTHENTICATION_ERROR" : e instanceof qt ? r = "RATE_LIMIT_ERROR" : e instanceof Vn ? r = "STORAGE_ERROR" : e instanceof Zn ? r = "TIMEOUT_ERROR" : e instanceof be ? r = "WIDGET_ERROR" : r = "UNKNOWN_ERROR", {
      message: Ol(e),
      code: r,
      isUserFacing: !0,
      shouldRetry: Lr(e),
...
const Dl = "https://ai-gateway-service-staging-639717727892.us-east4.run.app";
class Ks {
  ...
  static resolveProductionUrls(e) {
    const i = Dl, s = this.isLocalhostUrl(i) ? i : this.ensureHttps(i);
    return {
...
For production: npm run build (uses default staging gateway)`
      ...
      const o = Ks.resolveUrls(a.sanitizedValue);
      this.config = {
        ...n,
...
function Ql(t) {
  try {
    return Ui ? yi.get(t) ?? null : localStorage.getItem(t);
  } catch {
...
function Ll(t, e) {
  try {
    return Ui ? (yi.set(t, e), !0) : (localStorage.setItem(t, e), !0);
  } catch {
    return yi.set(t, e), Ui = !0, !1;
  }
}
function Pl(t) {
  try {
...
const Oe = class Oe {
   ...
   */
  getItem(e) {
    return this.storageAdapter ? this.storageAdapter.getItem(e) : Ql(e);
  }
  setItem(e, i) {
    this.storageAdapter ? this.storageAdapter.setItem(e, i) : Ll(e, i);
  }
  removeItem(e) {
    this.storageAdapter ? this.storageAdapter.removeItem(e) : Pl(e);
  }
  /**
...
Oe.VISITOR_ID_KEY = Br.VISITOR_ID, Oe.SESSION_HISTORY_KEY = Br.SESSIONS;
let Js = Oe;
class Di {
  /**
  ...
  static getApiUrl(e, i) {
    const { apiUrl: s } = Ks.resolveUrls(i.clientId, i.options);
    switch (e) {
      case "init":
        return `${s}/init`;
      case "chat":
  ...
  static getWebSocketUrl(e) {
    const { wsUrl: i } = Ks.resolveUrls(e.clientId, e.options), s = new URLSearchParams({
      session_id: e.sessionId
    });
    return e.visitorId && s.append("visitor_id", e.visitorId), `${i}?${s}`;
  }
}
var ee = /* @__PURE__ */ ((t) => (t.DISCONNECTED = "disconnected", t.CONNECTING = "connecting", t.CONNECTED = "connected", t.ERROR = "error", t))(ee || {});
class zl {
  constructor(e, i) {
    this.ws = null, this.sessionId = null, this.state = "disconnected", this.messageQueue = [], this.reconnectAttempts = 0, this.maxReconnectAttempts = ae.MAX_RECONNECT_ATTEMPTS, this.reconnectDelay = ae.RECONNECT_DELAY, this.heartbeatInterval = null, this.listeners = /* @__PURE__ */ new Map(), this.abortController = null, this.cleanupFunctions = [], this.config = e, this.visitor = i, this.debugLogger = gr(e.getAll());
  }
  /**
  ...
  send(e) {
    ...
    if (this.debugLogger.log("WebSocketManager", "JSON payload created", {
      ...
      }), this.messageQueue.length >= bt.MAX_QUEUE_SIZE) {
        this.debugLogger.warn("WebSocketManager", "Message queue full", {
          queueSize: this.messageQueue.length,
          maxSize: bt.MAX_QUEUE_SIZE
        }), this.emit("error", {
...
function _n(t, e) {
  ht(e, !0), Ut(t, Ul);
  let i = ut(e, "onclose", 7), s = ut(e, "connectionState", 23, () => ee.DISCONNECTED), r = ut(e, "connectionFailed", 7, !1);
  const n = /* @__PURE__ */ Se(() => {
  ...
  }), o = /* @__PURE__ */ Se(() => s() === ee.CONNECTING ? "pulse-slow" : s() === ee.ERROR ? "blink-slow" : "");
  function l() {
    var v;
    j.close(), (v = i()) == null || v();
  }
  var d = {
    ...
    set connectionState(v = ee.DISCONNECTED) {
      s(v), Ye();
    },
...
function $n(t, e) {
  ...
  return W(w), W(a), gt(
    (A, O) => {
      o = lr(a, 1, "message svelte-1uqoiy7", null, o, { user: m(r), assistant: !m(r) }), tt(a, "aria-label", m(r) ? "Your message" : "Assistant message"), cs(u, i().content), tt(w, "aria-label", A), cs(v, O);
    },
    [
...
Ht(ea, {}, [], [], !0);
var ql = /* @__PURE__ */ K('<div class="empty-state svelte-qha2j" role="status" aria-label="BotBrewers assistant ready"><div class="empty-icon svelte-qha2j" aria-hidden="true"><img alt="" class="brand-logo svelte-qha2j" width="68" height="68"/></div> <span class="brand-name svelte-qha2j">BotBrewers</span></div>'), Kl = /* @__PURE__ */ K('<div class="messages-container svelte-qha2j" role="list" aria-label="Messages"><!> <!></div>'), Jl = /* @__PURE__ */ K('<div class="error-message svelte-qha2j"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-qha2j"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20Z" fill="#ef4444"></path><path d="M11 7H13V13H11V7ZM11 15H13V17H11V15Z" fill="#ef4444"></path></svg> <p class="svelte-qha2j"> </p></div>'), Xl = /* @__PURE__ */ K('<div class="message-list svelte-qha2j" role="log" aria-live="polite" aria-label="Chat conversation"><!> <!></div>');
const Vl = {
  hash: "svelte-qha2j",
  ...
  /* Dark theme adjustments - Use CSS variables for maintainability */[data-theme="dark"] .empty-icon.svelte-qha2j {background:var(--widget-surface);border:1px solid var(--widget-border);}[data-theme="dark"] .brand-name.svelte-qha2j {color:var(--widget-text-muted);}`
};
function ta(t, e) {
  ht(e, !0), Ut(t, Vl);
  let i, s = !0;
  ...
  async function r() {
    await Rn(), i && (i.scrollTop = i.scrollHeight);
  }
  function n() {
    if (i) {
      const { scrollTop: f, scrollHeight: p, clientHeight: g } = i;
      s = p - f - g < 100;
    }
  }
  cr(() => {
  ...
  {
    var l = (f) => {
      var p = ql(), g = q(p), w = q(g);
      W(g), Xr(2), W(p), gt(() => tt(w, "src", yl)), N(f, p);
    }, d = (f) => {
      var p = Kl(), g = q(p);
      Uo(g, 17, () => S.messages, (v) => v.id, (v, A) => {
        $n(v, {
          get message() {
            return m(A);
          }
...
function ia(t, e) {
  ht(e, !0), Ut(t, _l);
  let i = ut(e, "onsend", 7), s = ut(e, "disabled", 7, !1), r = /* @__PURE__ */ T(""), n;
  function a() {
    var O, H, B, Q;
    const v = je().generate();
    ...
    P.log("InputBar", "After trimming", {
      ...
      willSend: !0
    }), je().setCurrent(v), (Q = i()) == null || Q(A), C(r, ""), l()) : P.log("InputBar", "Send blocked", {
      correlationId: v,
      hasContent: !!A,
      disabled: s(),
      isTyping: S.isTyping,
  ...
  const d = /* @__PURE__ */ Se(() => s() || S.isTyping || S.error !== null), u = /* @__PURE__ */ Se(() => S.isTyping ? "Waiting for response..." : S.error ? "Error occurred" : Cs.placeholder);
  var h = {
    get onsend() {
      return i();
    },
  ...
  po(g), g.__keydown = o, g.__input = l, dr(g, (v) => n = v, () => n);
  var w = X(g, 2);
  return w.__click = a, W(p), W(f), gt(
    (v) => {
      tt(g, "placeholder", m(u)), g.disabled = m(d), w.disabled = v;
    },
    [() => m(d) || !m(r).trim()]
  ), $o(g, () => m(r), (v) => C(r, v)), N(t, f), pt(h);
}
Is(["keydown", "input", "click"]);
Ht(ia, { onsend: {}, disabled: {} }, [], [], !0);
class $l {
  constructor(e, i) {
    this.sessionId = null, this.config = e, this.visitor = i, this.debugLogger = gr(e.getAll());
  }
  /**
  ...
  async initialize() {
    try {
      const e = new AbortController(), i = setTimeout(() => e.abort(), ae.API_TIMEOUT), s = Di.getApiUrl("init", {
        clientId: this.config.clientId
      }), r = {
      ...
      if (e instanceof Qi || e instanceof Wt || e instanceof qt)
        throw e;
      const i = Li.handle(e, {
        component: "APIClient",
        action: "initialize"
  ...
  async sendMessage(e) {
    ...
    try {
      ...
      if (this.debugLogger.log("APIClient", "Message validation result", {
        ...
        throw this.debugLogger.error("APIClient", "Validation failed", { correlationId: i, error: n.error }), new Qi(n.error || "Validation failed", "message", e);
      ...
      if (clearTimeout(o), this.debugLogger.log("APIClient", "HTTP response status", {
        ...
        if (u.status === 429) {
          const f = u.headers.get("Retry-After"), p = f ? parseInt(f, 10) : 60;
          throw new qt(
      ...
      if (this.debugLogger.error("APIClient", "sendMessage() error", { correlationId: i, error: n }), n instanceof Qi || n instanceof Wt || n instanceof qt)
        throw n;
      const a = Li.handle(n, {
        component: "APIClient",
        action: "sendMessage",
  ...
  async validateSessionHealth() {
    if (!this.sessionId)
      return !1;
    try {
      const e = new AbortController(), i = setTimeout(() => e.abort(), ae.API_TIMEOUT), s = Di.getApiUrl("sessionHealth", {
        clientId: this.config.clientId,
        sessionId: this.sessionId
      }), r = {
        client_id: this.config.clientId,
...
class ed {
  ...
  handleConnectionEstablished(e) {
    ...
    i && !this.chatStore.hasMessages && (this.chatStore.addMessage(i, "assistant"), this.debugLogger.log("ChatController", "Initial message added"));
  }
...
var td = /* @__PURE__ */ K('<span class="error-message svelte-zsv8oa" id="error-message">Connection lost. Unable to reconnect.</span> <button class="restart-button svelte-zsv8oa" aria-describedby="error-message">Retry Connection</button>', 1), id = /* @__PURE__ */ K('<span class="error-message svelte-zsv8oa" id="error-message">Something went wrong. Please try again.</span> <button class="restart-button svelte-zsv8oa" aria-describedby="error-message">Retry Connection</button>', 1), sd = /* @__PURE__ */ K('<div class="error-banner svelte-zsv8oa" role="alert" aria-live="polite"><!></div>'), rd = /* @__PURE__ */ K('<button class="backdrop svelte-zsv8oa" aria-label="Close chat overlay" tabindex="-1"></button>'), nd = /* @__PURE__ */ K('<div class="chat-container svelte-zsv8oa" role="dialog" aria-label="Chat assistant" aria-modal="true" tabindex="-1"><!> <!> <!> <!></div> <!>', 1), ad = /* @__PURE__ */ K('<div class="widget-container svelte-zsv8oa"><!> <!></div>');
const od = {
  hash: "svelte-zsv8oa",
...
function sa(t, e) {
  ht(e, !0), Ut(t, od);
  let i = ut(e, "hostElement", 7), s, r, n, a, o, l;
  const d = je();
  let u = !1, h = !1, f = null, p = /* @__PURE__ */ T(te(ee.DISCONNECTED)), g = /* @__PURE__ */ T(
    !1
    // Track if max reconnection attempts exhausted
  ), w = /* @__PURE__ */ T(null), v = null;
  function A() {
    var L;
  ...
  function O(b) {
    ...
    const _ = E[0], mt = E[E.length - 1];
    return requestAnimationFrame(() => _.focus()), { firstFocusable: _, lastFocusable: mt };
  }
  function H(b) {
    ...
    if (b.key === "Tab" && m(w)) {
      ...
      if (E.length === 0) return;
      const _ = E[0], mt = E[E.length - 1];
      b.shiftKey && document.activeElement === _ ? (b.preventDefault(), mt.focus()) : !b.shiftKey && document.activeElement === mt && (b.preventDefault(), _.focus());
    }
  }
  function B() {
  ...
  cr(async () => {
    try {
      if (s = new Rl(i()), l = gr(s.getAll()), r = new Js(), n = new $l(s, r), a = new zl(s, r), o = new ed(S, j, l), i()) {
        const { configStore: b } = await Promise.resolve().then(() => ml);
        b.loadFromAttributes(i());
      }
      J(), A(), l.log("ChatWidget", "Attaching WebSocket listeners"), a.on("message", xs), a.on("stateChange", (b) => {
        ...
        l.error("ChatWidget", "WebSocket connection failed after max attempts", b), C(g, !0), f = b.error, S.setError(b.error);
      }), l.log("ChatWidget", "WebSocket listeners attached successfully"), j.isOpen && await ge(), l.log("ChatWidget", "Services initialized successfully");
    } catch (b) {
    ...
    if (!(u || h)) {
      ...
      try {
        if (j.setLoading(!0), await n.resumeSession()) {
          ...
          (b = E.assistant_info) != null && b.assistant_name && Cs.setBackendTitle(E.assistant_info.assistant_name), await a.connect(E.session_id), setTimeout(
            () => {
  ...
  async function na(b) {
    ...
    if (o.resetForNewMessage(), l.log("ChatWidget", "Message added to store", {
    ...
    }), u || (l.log("ChatWidget", "Widget not initialized, initializing...", { correlationId: L }), await ge()), l.log("ChatWidget", "Connection state", {
      correlationId: L,
      connectionState: m(p),
      isConnected: m(p) === ee.CONNECTED,
      routingTo: m(p) === ee.CONNECTED ? "WebSocket" : "HTTP API"
    }), m(p) === ee.CONNECTED) {
      ...
      try {
        ...
        l.error("ChatWidget", "WebSocket send error", _), S.updateMessageStatus(E.id, "failed"), S.setError("Failed to send message. Please try again.");
        return;
      }
    } else
      try {
        l.log("ChatWidget", "Sending via HTTP API", { correlationId: L, content: b }), o.setTypingWithTimeout();
        const _ = await n.sendMessage(b);
        l.log("ChatWidget", "HTTP API response received", {
          correlationId: L,
          response: _.response,
          sessionId: _.session_id
        }), S.addMessage(_.response, "assistant"), S.setTyping(!1), j.isOpen || j.markUnread();
      } catch (_) {
        l.error("ChatWidget", "HTTP API error", _), f = "Failed to send message. Please try again.", S.setError(f), S.updateMessageStatus(E.id, "failed"), S.setTyping(!1);
      }
  }
  async function aa() {
    l.log("ChatWidget", "Toggle clicked, current state", m(Ji)), j.isOpen || B(), j.toggle(), await new Promise((b) => setTimeout(b, 0)), l.log("ChatWidget", "New state", j.isOpen), j.isOpen && !u && s && await ge(), j.isOpen ? requestAnimationFrame(() => de()) : Q();
  }
  function oa() {
    S.clearMessages(), S.setError(null), f = null;
  }
  function la() {
    l.log("ChatWidget", "Manual retry connection requested"), C(g, !1), f = null, S.setError(null), a == null || a.retryConnection();
  }
  const Ji = /* @__PURE__ */ Se(() => j.isOpen), da = /* @__PURE__ */ Se(() => j.isLoading), ca = /* @__PURE__ */ Se(() => (s == null ? void 0 : s.position) || "bottom-right");
  var ua = {
    get hostElement() {
      return i();
    },
  ...
  var fa = X(hr, 2);
  {
    var ha = (b) => {
      ...
      var pr = X(mt, 2);
      {
        let Me = /* @__PURE__ */ Se(() => S.error !== null || m(da));
        ia(pr, {
          onsend: na,
          get disabled() {
            return m(Me);
      ...
      var pa = X(pr, 2);
      {
        var va = (Me) => {
          ...
          {
            var Aa = (Gt) => {
              var ki = td(), ks = X(is(ki), 2);
              ks.__click = la, N(Gt, ki);
            }, ya = (Gt) => {
              var ki = id(), ks = X(is(ki), 2);
              ks.__click = oa, N(Gt, ki);
            };
            ke(ba, (Gt) => {
              m(g) ? Gt(Aa) : Gt(ya, !1);
            });
      ...
      W(E), dr(E, (Me) => C(w, Me), () => m(w));
      var ma = X(E, 2);
      {
        var wa = (Me) => {
          var wt = rd();
          wt.__click = () => j.close(), Sr(3, wt, () => cl, () => ({ duration: 200 })), N(Me, wt);
        };
        ke(ma, (Me) => {
          m(Ji) && Me(wa);
        });
      }
      Sr(3, E, () => ul, () => ({ y: 20, duration: 300 })), N(b, L);
    };
    ke(fa, (b) => {
      m(Ji) && b(ha);
    });
  }
  return W(Xi), gt(() => tt(Xi, "data-position", m(ca))), N(t, Xi), pt(ua);
}
Is(["keydown", "click"]);
Ht(sa, { hostElement: {} }, [], [], !0);
const fr = {
...
const ra = {
  ...
  // Bot Blue (keep)
  primaryHover: "#2a6bbe",
  // Lighter on hover (better visibility)
  primaryLight: "#64b5f6",
  // Tech blue for interactive elements
  primaryDark: "#0f2d5a",
  // Dark blue
  background: "#0a0e14",
  // Deep dark (unchanged)
...
class Nr extends HTMLElement {
  ...
  disconnectedCallback() {
    this._app && (Fs(this._app), this._app = null);
  }
  attributeChangedCallback(e, i, s) {
    i !== s && ((e === "theme" || e === "data-theme") && s && (this._currentTheme = s, this.updateStyles()), e === "accent-color" && s && this.updateAccentColor(s), e === "client-id" && s && this._app && (P.log("ChatWidget", `Client ID changed from ${i} to ${s}, remounting widget`), Fs(this._app), this._app = null, this.mountApp()));
  }
  mountApp() {
    ...
    s.textContent = this.getStyles(), this._shadowRoot.innerHTML = "", this._shadowRoot.appendChild(s), this._shadowRoot.appendChild(i), this._app = or(sa, {
      target: i,
      props: {
        hostElement: this
      }
  ...
  updateAccentColor(e) {
    ...
    i && Promise.resolve().then(() => pl).then(({ adjustColor: s }) => {
...
document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", Ur) : Ur();
function Ur() {
